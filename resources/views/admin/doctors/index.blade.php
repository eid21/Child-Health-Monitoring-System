                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tr>
                            ...
                            <th class="px-4 py-3">Bio</th> <!-- Added Bio column -->
                        ...
                        @forelse($doctors as $doctor)
                            <tr>
                                ...
                                <td class="px-4 py-3">{{ Str::limit($doctor->bio, 50) }}</td> <!-- Display truncated bio -->
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center py-4 text-muted"> <!-- Updated colspan to 7 -->
