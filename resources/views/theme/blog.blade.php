...
@section('content')
    <main>
        <!--? Slider Area Start-->
        @include('theme.partials.slider', ['title' => 'Blog', 'subtitle' => 'Almost before we knew it, we had left the ground'])
                ...
                <div class="blog_left_sidebar">
                    <article class="blog_item">
                        ...
                        <div class="blog_details">
                            <a class="d-inline-block" href="{{ route('theme.blog-details') }}">
                    ...
                    <aside class="single_sidebar_widget popular_post_widget">
                        ...
                        <div class="media post_item">
                            ...
                            <div class="media-body">
                                <a href="{{ route('theme.blog-details') }}">
